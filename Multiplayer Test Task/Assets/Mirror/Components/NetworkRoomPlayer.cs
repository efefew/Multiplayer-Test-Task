...
namespace Mirror
{
    ...
    {
        public event Action<bool> ReadyToBeginHandler;
        public event Action<int> IndexHandler;
        /// <summary>
        ...
        public virtual void IndexChanged(int oldIndex, int newIndex) => IndexHandler?.Invoke(newIndex);
        ...
        public virtual void ReadyStateChanged(bool oldReadyState, bool newReadyState) => ReadyToBeginHandler?.Invoke(newReadyState);
