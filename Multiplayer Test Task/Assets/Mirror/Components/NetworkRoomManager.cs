...
namespace Mirror
{
    ...
    {
        public event Action<NetworkRoomPlayer> AddRoomPlayerHandler;
        public event Action<NetworkRoomPlayer> RemoveRoomPlayerHandler;
        public event Action<bool> AllPlayersReadyHandler;
        ...
        public bool allPlayersReady
        {
            ...
            set
            {
                ...
                if (wasReady != nowReady)
                {
                    ...
                    AllPlayersReadyHandler?.Invoke(_allPlayersReady);
                    if (nowReady)
        ...
        internal void CallOnClientEnterRoom()
        {
            ...
            {
                AddRoomPlayerHandler?.Invoke(player);
        ...
        internal void CallOnClientExitRoom()
        {
            ...
            foreach (NetworkRoomPlayer player in roomSlots)
            {
                RemoveRoomPlayerHandler?.Invoke(player);
        ...
        public override void OnServerAddPlayer(NetworkConnectionToClient conn)
        {
            ...
            if (Utils.IsSceneActive(RoomScene))
            {
                ...
                {
                    newRoomGameObject = Instantiate(roomPlayerPrefab.gameObject, Vector3.zero, Quaternion.identity);// создаем игрока
                }

                _ = NetworkServer.AddPlayerForConnection(conn, newRoomGameObject);// заспавниваем игрока для подключения
                //newRoomGameObject.transform.parent = roomPlayerConteiner;
            }
            else
            {
            ...
            if (newSceneName == RoomScene)
            {
                foreach (NetworkRoomPlayer roomPlayer in roomSlots)
                {
                    ...
                    if (NetworkServer.active)
                    {
                        ...
                        _ = NetworkServer.ReplacePlayerForConnection(identity.connectionToClient, roomPlayer.gameObject);
                    }
                }
        ...
        /// </summary>
        public override void OnStartHost() => OnRoomStartHost();
        ...
        /// </summary>
        public override void OnStopHost() => OnRoomStopHost();
        ...
        /// </summary>
        /// <param name="conn">The connection the player object is for.</param>
        public virtual void OnRoomServerAddPlayer(NetworkConnectionToClient conn) => base.OnServerAddPlayer(conn);
        ...
        {
#if UNITY_SERVER
            ServerChangeScene(GameplayScene);// all players are readyToBegin, start the game
#endif
        }
