...
namespace Mirror
{
    ...
    public static partial class NetworkClient
    {
        ...
        public static bool active => connectState is ConnectState.Connecting or
        ...
        internal static readonly Dictionary<ulong, NetworkIdentity> spawnableObjects =
            new();
        private static Unbatcher unbatcher = new();
        ...
        public static void ReplaceHandler<T>(Action<T> handler, bool requireAuthentication = true)
            where T : struct, NetworkMessage => ReplaceHandler((NetworkConnection _, T value) => { handler(value); }, requireAuthentication);
        ...
        internal static void ApplySpawnPayload(NetworkIdentity identity, SpawnMessage message)
        {
            ...
            if (identity.isOwned) _ = (connection?.owned.Add(identity));
        ...
        internal static void OnHostClientSpawn(SpawnMessage message)
        {
            ...
            {
                spawned[message.netId] = identity;
                if (message.isOwner) _ = connection.owned.Add(identity);
        ...
        internal static void ChangeOwner(NetworkIdentity identity, ChangeOwnerMessage message)
        {
            ...
            _ = identity.isOwned ? (connection?.owned.Add(identity)) : (connection?.owned.Remove(identity));
        ...
        // broadcast ///////////////////////////////////////////////////////////
        private static void BroadcastTimeSnapshot() => Send(new TimeSnapshotMessage(), Channels.Unreliable);
