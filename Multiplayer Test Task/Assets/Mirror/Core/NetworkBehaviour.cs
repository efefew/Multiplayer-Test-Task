...
namespace Mirror
{
    ...
    public abstract class NetworkBehaviour : MonoBehaviour
    {
        ...
        private void SetSyncObjectDirtyBit(ulong dirtyBit) => syncObjectDirtyBits |= dirtyBit;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SetSyncVarDirtyBit(ulong dirtyBit) => syncVarDirtyBits |= dirtyBit;
        ...
        protected static bool SyncVarEqual<T>(T value, ref T fieldValue) =>
            ...
            EqualityComparer<T>.Default.Equals(value, fieldValue);
